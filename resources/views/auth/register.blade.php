<x-guest-layout>
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <!-- Ciudad -->
            <div>
                <x-label for="ciudad_usuario" :value="__('City')" />

                <x-input id="ciudad_usuario" class="block mt-1 w-full" type="text" name="ciudad_usuario" :value="old('ciudad_usuario')" required
                    autofocus />
            </div>
